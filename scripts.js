...
function clickName() {
    document.getElementById('name').innerHTML = "Shaun Wrenn";
}

// random value generated for JS minigame
var y = Math.floor(Math.random() * 10 + 1);

// counting the number of guesses before correct guess
var guess = 1;
...
// Bootstrap JS (several edits by me)
